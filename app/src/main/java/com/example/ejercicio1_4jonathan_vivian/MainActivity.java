...
import com.example.ejercicio1_4jonathan_vivian.Procesos.AlertDialogo;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText txtnombres, txtdescripcion;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnSQL.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if(!txtnombres.getText().toString().isEmpty() && !txtdescripcion.getText().toString().isEmpty()
    ...
    private void agregarPictureSQL(){
        ...
        values.put(Transacciones.apellidos, txtdescripcion.getText().toString());
            ...
            try {
                if (photoFile != null) {
                    Uri photoURI = FileProvider.getUriForFile(this,
                            "com.example.ejercicio1_4jonathan_vivian.fileprovider",
